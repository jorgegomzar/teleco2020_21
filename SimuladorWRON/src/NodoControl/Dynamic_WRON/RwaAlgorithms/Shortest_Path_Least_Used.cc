...
#include "Shortest_Path_Least_Used.h"

Define_Module(Shortest_Path_Least_Used);

int Shortest_Path_Least_Used::numInitStages() const{return 2;}

void Shortest_Path_Least_Used::initialize(int stage)
{
...
void Shortest_Path_Least_Used::handleMessage(cMessage *msg)
{
