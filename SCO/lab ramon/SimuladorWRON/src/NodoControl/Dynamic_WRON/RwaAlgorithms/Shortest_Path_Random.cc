...
#include "Shortest_Path_Random.h"

Define_Module(Shortest_Path_Random);

int Shortest_Path_Random::numInitStages() const{return 2;}

void Shortest_Path_Random::initialize(int stage)
{
...
void Shortest_Path_Random::handleMessage(cMessage *msg)
{
